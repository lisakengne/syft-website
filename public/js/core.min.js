 ...
 * @module Switcher
 */
(function($){"use strict";$('.switcher-setting').on('click',function(){if($('#style-switcher').hasClass('active')){$('#style-switcher').removeClass('active');}else{$('#style-switcher').removeClass('active');$('#style-switcher').addClass('active');}});$('.boxed,.pattren-wrap a').on('click',function(){$('.main-wrapper').addClass('wrapper-boxed');$('.main-wrapper').removeClass('wrapper-wide');$(window).resize();});$('.wide').on('click',function(){$('.main-wrapper').addClass('wrapper-wide');$('.main-wrapper').removeClass('wrapper-boxed');$(window).resize();});$('.bg-list li a').on('click',function(){var bg=$(this).css("backgroundImage");$("body").css("backgroundImage",bg);$(window).resize();});$(".style1").on("click",function(){$("#colors").attr("href","css/styles.css");$("#logo").attr("src","img/logos/logo_01.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");var bluelogo=$(".navbar-brand.blue-logo img");var darklogo=$(".navbar-brand.dark-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');bluelogo.attr('src','img/logos/logo-white.png');darklogo.attr('src','img/logos/logo_01.png');} else{innerlogo.attr('src','img/logos/logo_01.png');bluelogo.attr('src','img/logos/logo_01.png');darklogo.attr('src','img/logos/logo-white.png');}});return false;});$(".style2").on("click",function(){$("#colors").attr("href","css/styles-2.css");$("#logo").attr("src","img/logos/logo_02.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");var bluelogo=$(".navbar-brand.blue-logo img");var darklogo=$(".navbar-brand.dark-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');bluelogo.attr('src','img/logos/logo-white.png');darklogo.attr('src','img/logos/logo_02.png');} else{innerlogo.attr('src','img/logos/logo_02.png');bluelogo.attr('src','img/logos/logo_02.png');darklogo.attr('src','img/logos/logo-white.png');}});return false;});$(".style3").on("click",function(){$("#colors").attr("href","css/styles-3.css");$("#logo").attr("src","img/logos/logo_03.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");var bluelogo=$(".navbar-brand.blue-logo img");var darklogo=$(".navbar-brand.dark-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');bluelogo.attr('src','img/logos/logo-white.png');darklogo.attr('src','img/logos/logo_03.png');} else{innerlogo.attr('src','img/logos/logo_03.png');bluelogo.attr('src','img/logos/logo_03.png');darklogo.attr('src','img/logos/logo-white.png');}});return false;});$(".style4").on("click",function(){$("#colors").attr("href","css/styles-4.css");$("#logo").attr("src","img/logos/logo_04.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");var bluelogo=$(".navbar-brand.blue-logo img");var darklogo=$(".navbar-brand.dark-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');bluelogo.attr('src','img/logos/logo-white.png');darklogo.attr('src','img/logos/logo_04.png');} else{innerlogo.attr('src','img/logos/logo_04.png');bluelogo.attr('src','img/logos/logo_04.png');darklogo.attr('src','img/logos/logo-white.png');}});return false;});})(jQuery);
